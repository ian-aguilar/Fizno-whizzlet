...
import HomepageTable from "./managefaq-table";
import { useEffect, useState } from "react";
import { AdminApi } from "@fizno/api-client/src/apis/AdminApi";
import { Alert, CircularProgress, Snackbar } from "@mui/material";
import SVG from "@/public/svg";
import ManageFaqTable from "./managefaq-table";

function ManageFaqContent() {
  ...
  const handleGetAllBanner = async () => {
    const response = await AdminApi.getAllFaqQuestions();
