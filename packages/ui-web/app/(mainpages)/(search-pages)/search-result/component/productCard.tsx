...
export default function ProductCard({ type, product }: ProductCardProps) {
  ...
  return (
    <div
      className={`product_card border-2 p-3 rounded-lg ${type === "listView" ? "flex w-full list_view_main" : "block"}`}
    >
      <div
      ...
      >
        ...
        >
          <Image
            className="product_card_img mx-auto"
            src={imageSrc}
            width={200}
            height={250}
            alt={product.title}
            onError={() => setImageSrc("/images/mainpages/productPic.png")}
          />
        </div>
      ...
      <div className="py-2 w-full">
        ...
        >
          <div className={`${type === "listView" ? "w-6/12" : "w-full"}`}>
            <h5
              className="text-zinc-600 text-sm normal-case font-medium leading-4"
              style={{
                display: "-webkit-box",
                WebkitLineClamp: 2,
