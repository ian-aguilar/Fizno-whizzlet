          ...
          <div className="space-y-8 mt-8">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center -m-1.5">
                ...
                <div className="m-1.5">
                  {/* Start */}
                  <button className="btn dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-indigo-500">
                    Secondary
                  </button>
                  {/* End */}
                </div>
                ...
                <div className="m-1.5">
                  {/* Start */}
                  <button className="btn dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-emerald-500">
                    Success
                  </button>
                  {/* End */}
                </div>
              ...
              <div className="flex flex-wrap items-center -m-1.5">
                <div className="m-1.5">
                  ...
                  <div className="flex flex-wrap -space-x-px">
                    <button className="btn bg-indigo-600 text-white rounded-none border-l-indigo-400 first:rounded-l last:rounded-r first:border-l-transparent">
                      Weekly
                    </button>
                ...
                <div className="m-1.5">
                  {/* Start */}
                  <div className="flex flex-wrap -space-x-px">
                    <button className="btn bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 hover:bg-slate-50 text-indigo-500 rounded-none first:rounded-l last:rounded-r">
                      Weekly
                    </button>
