...
interface RealtimeChartProps {
  data: ChartData; // Add the 'data' prop to the interface
  width: number;
  height: number;
}

export default function RealtimeEarningChart({
  data, // Destructure 'data' from the props
  width,
  height,
}: RealtimeChartProps) {
      ...
      options: {
        ...
        scales: {
          ...
          x: {
            ...
            min: "2023-01-01", // Start of the year (adjust as needed)
            max: "2023-12-31", // End of the year (adjust as needed)
            border: {
              display: false,
            },
            grid: {
            ...
            ticks: {
              autoSkip: false, // Ensure no month is skipped
              maxRotation: 0,
              color: darkMode ? textColor.dark : textColor.light,
            },
          },
    ...
    <>
      <div className="px-5 py-1">
        <div className="flex items-start">
          <div className="text-xl font-bold text-slate-800 dark:text-slate-100 mr-2 tabular-nums">
