      ...
      plugins: [
        {
          ...
          afterUpdate(c) {
            ...
            items?.forEach((item) => {
              ...
              // @ts-expect-error This is necessary because dataset.data may not always be defined.
              const theValue: number = dataset.data
                ? // @ts-expect-error We expect dataset.data to be an array for reduce function.
