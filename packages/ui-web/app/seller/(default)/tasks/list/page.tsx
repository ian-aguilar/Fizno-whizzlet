          ...
          <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-4">
            ...
            <div className="flex shrink-0 -space-x-3 -ml-px">
              <a className="block" href="#0">
                <Image
                  className="rounded-full border-2 border-slate-100 dark:border-slate-900 box-content"
                  src={UserImage08}
                  width="32"
                  height="32"
                  alt="User 08"
        ...
        <div className="space-y-6">
                      ...
                      <li>
                        <label className="flex items-center">
                          <input
                            ...
                            defaultChecked
                          />
                          <span className="text-sm text-slate-800 dark:text-slate-100 peer-checked:line-through ml-3">
          ...
          <div>
            ...
            <div className="space-y-2">
              {/* Task */}
              <div
                className="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4 opacity-60"
                draggable="true"
              >
                <div className="sm:flex sm:justify-between sm:items-start">
                  {/* Left side */}
