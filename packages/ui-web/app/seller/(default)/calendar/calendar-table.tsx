            ...
            >
              <div className="h-full flex flex-col justify-between">
                ...
                <div className="grow flex flex-col relative p-0.5 sm:p-1.5 overflow-hidden">
                  {getEvents(day).map((event) => {
                    return (
                      ...
                      >
                        <div
                          className={`px-2 py-0.5 rounded overflow-hidden ${eventColor(event.eventColor)}`}
                        >
                          {/* Event name */}
                ...
                <div className="flex justify-between items-center p-0.5 sm:p-1.5">
                  ...
                  {/* Day number */}
                  <button
                    className={`inline-flex ml-auto w-6 h-6 items-center justify-center text-xs sm:text-sm dark:text-slate-300 font-medium text-center rounded-full hover:bg-indigo-100 dark:hover:bg-slate-600 ${isToday(day) && "text-indigo-500"}`}
                  >
                    {day}
                  </button>
                </div>
