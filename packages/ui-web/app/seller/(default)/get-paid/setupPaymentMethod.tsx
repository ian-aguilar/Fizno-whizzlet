...
interface GetPaidProps {
  setSetupPaymentModalOpen: React.Dispatch<React.SetStateAction<boolean>>;
}
const SetupPaymentMethod: React.FC<GetPaidProps> = ({
  setSetupPaymentModalOpen,
}) => {
  return (
    <>
      {" "}
      ...
      <div className="flex justify-end mt-10">
        <button
          ...
          onClick={() => setSetupPaymentModalOpen(false)}
