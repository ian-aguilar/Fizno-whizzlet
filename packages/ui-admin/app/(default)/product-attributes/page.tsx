...
import ProductAttributesTable from "./product-category-table";
...
function ProductAttributesContent() {
  ...
  const attributes = [
    {
      ...
      name: "Dirt Bike",
      slug: "color",
      orderBy: "custom ordering",
      term: "Black,black bluesingh,black leather,Blue, ",
    },
    {
      id: 1,
      image: Image01,
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
      ...
      <div className="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
          ...
          <button
            ...
            onClick={() => router.push("/add-product-attributes")}
          >
      ...
      {/* Table */}
      <ProductAttributesTable attributes={allAttributes} />
