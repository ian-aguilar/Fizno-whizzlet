      ...
      <div className="flex flex-col h-full">
        ...
        <div className="border-t border-slate-200 dark:border-slate-700">
          <div className="flex divide-x divide-slate-200 dark:divide-slate-700">
            <Link
              className="block flex-1 text-center text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 font-medium px-3 py-4"
              href="/messages"
            >
            ...
            >
              <div className="flex items-center justify-center">
                <svg
                  className="w-4 h-4 fill-current text-slate-400 dark:text-slate-600 group-hover:text-slate-500 shrink-0 mr-2"
                  viewBox="0 0 16 16"
                >
