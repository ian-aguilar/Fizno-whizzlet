  ...
  return (
    <tr>
      ...
      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <div className="text-center text-xs rounded-sm text-white bg-red-500 capitalize">
          {product.status}
        </div>
      </td>
      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
      ...
      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <div className="text-center">
          <b>Categories:</b>
          {product.taxonomies?.map((item: any, index: any) => (
            <span key={index} className="block text-emerald-500 font-semibold">
              {item.categories}
            </span>
          ))}
        </div>
        <div className="text-center">
          ...
          {product.taxonomies?.map((item: any, index: any) => (
            <span
              key={index}
              className="block text-red-500 uppercase font-semibold"
            >
              {item.conditions}
            </span>
          ))}
